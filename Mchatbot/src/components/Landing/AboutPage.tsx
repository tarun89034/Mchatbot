          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-gray-600 mb-6">
                Health challenges affect millions of people worldwide, yet access to support remains 
                limited by cost, availability, and stigma. We created Mchatbot to bridge this gap by 
                providing immediate, compassionate, and evidence-based support through 
