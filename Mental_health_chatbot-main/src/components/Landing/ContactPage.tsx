...
const ContactPage: React.FC = () => {
  ...
  const professionalResources = [
    ...
    },
    {
      ...
      description: "Mental health screening and local resources",
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-gray-900 mb-4">Professional Mental Health Resources</h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Find licensed mental health professionals and ongoing support services
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="bg-gradient-to-br from-blue-50 to-purple-50 rounded-2xl p-8">
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-start space-x-3">
                  <Heart className="w-6 h-6 text-blue-600 flex-shrink-0 mt-1" />
                  <p className="text-gray-700">Mental health treatment is effective and can significantly improve your quality of life</p>
                </div>
                <div className="flex items-start space-x-3">
                  <Heart className="w-6 h-6 text-blue-600 flex-shrink-0 mt-1" />
                  <p className="text-gray-700">You deserve support and care for your mental health</p>
                </div>
                <div className="flex items-start space-x-3">
                  <Heart className="w-6 h-6 text-blue-600 flex-shrink-0 mt-1" />
