...
app = FastAPI(
    ...
    description="AI-driven chatbot for mental health support with mood tracking and emotion analysis",
    version="1.0.0"
)
...
async def startup_event():
    ...
    logger.info("Mental Health Chatbot API started successfully")
